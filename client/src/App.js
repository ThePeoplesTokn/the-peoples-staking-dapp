...
import artifact from './abi/Staking.json';
import NavBar from './components/NavBar'
import StakeModal from './components/StakeModal'
import { Bank, PiggyBank, Coin } from 'react-bootstrap-icons'
import logoImg from "./images/bnb-logo.png"

const CONTRACT_ADDRESS = '0x796096Dc12cDDc4833684033d6483F2F93c7B901'

function App() {
  // general
  const [provider, setProvider] = useState(undefined)
  const [signer, setSigner] = useState(undefined)
  const [contract, setContract] = useState(undefined)// eslint-disable-next-line
      ...
      <div className="appBody">
        <div className="marketContainer">
          <div className="subContainer">
            <span>
              <img className="logoImg" alt="bnb-logo" src={ logoImg }/>
            </span>
